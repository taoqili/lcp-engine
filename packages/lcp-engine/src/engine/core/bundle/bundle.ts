...
const settersMap = new Map<string, ReactElement | ComponentType<any>>();
export function registerSetter(type: string, setter: ReactElement | ComponentType<any>) {
  settersMap.set(type, setter);
}

export function getSetter(type: string): ReactElement | ComponentType<any> | null {
