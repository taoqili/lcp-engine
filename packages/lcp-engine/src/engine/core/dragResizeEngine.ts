...
class DragResizeEngine {
  ...
  private dragResizing: boolean = false;

  constructor() {
    this.emitter = new EventEmitter();
  }

  public isDragResizing() {
   ...
   */
  public from(shell: Element, direction: string, boost: (e: MouseEvent) => any) {
    let node: any;
  ...
  public onResizeStart(func: (e: MouseEvent, direction: string, node: any) => any) {
  ...
  public onResize(func: (e: MouseEvent, direction: string, node: any, moveX: number, moveY: number) => any) {
  ...
  public onResizeEnd(func: (e: MouseEvent, direction: string, node: any) => any) {
